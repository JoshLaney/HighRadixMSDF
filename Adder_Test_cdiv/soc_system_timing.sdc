...
create_generated_clock -divide_by 2 -source {soc_inst|pll_0|altera_pll_i|cyclonev_pll|counter[0].output_counter|divclk} -name clk_neg [get_registers soc_system:soc_inst|clock_div:clock_div_0|clk_neg]
