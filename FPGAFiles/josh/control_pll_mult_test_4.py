...
err_path = 'mult/control_w%d/control_w%d_err.csv' % (WIDTH,WIDTH)
abs_err_path = 'mult/control_w%d/control_w%d_abs_err.csv' % (WIDTH,WIDTH)
mr_err_path = 'mult/control_w%d/control_w%d_mr_err.csv' % (WIDTH,WIDTH)
bf_loc_path = 'mult/control_w%d/control_w%d_bf_loc.csv' % (WIDTH,WIDTH)
