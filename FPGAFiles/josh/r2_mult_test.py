...
a_file = open('mult/a_p_data.txt', 'r')
...
b_file = open('mult/b_p_data.txt', 'r')
...
a_file = open('mult/a_n_data.txt', 'r')
...
b_file = open('mult/b_n_data.txt', 'r')
...
c_file = open('mult/c_p_data.txt', 'w')
...
c_file = open('mult/c_n_data.txt', 'w')
...
diff = os.popen('diff mult/c_p_data.txt mult/c_p_data_GOLD.txt')
output = diff.read()
if(output != ''):
...
diff = os.popen('diff mult/c_n_data.txt mult/c_n_data_GOLD.txt')
output = diff.read()
if(output != ''):
