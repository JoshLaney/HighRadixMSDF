...
a_p_file = open('mult/a_p_data.txt', 'w')
b_p_file = open('mult/b_p_data.txt', 'w')
gold_p_file = open('mult/c_p_data_GOLD.txt', 'w')
...
a_n_file = open('mult/a_n_data.txt', 'w')
b_n_file = open('mult/b_n_data.txt', 'w')
gold_n_file = open('mult/c_n_data_GOLD.txt', 'w')
