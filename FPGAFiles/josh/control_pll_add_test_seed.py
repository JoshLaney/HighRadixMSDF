...
err_path = 'add/control_w%d/control_w%d_err_s%d.csv' % (WIDTH,WIDTH,SEED)
abs_err_path = 'add/control_w%d/control_w%d_abs_err_s%d.csv' % (WIDTH,WIDTH,SEED)
mr_err_path = 'add/control_w%d/control_w%d_mr_err_s%d.csv' % (WIDTH,WIDTH,SEED)
bf_loc_path = 'add/control_w%d/control_w%d_bf_loc_s%d.csv' % (WIDTH,WIDTH,SEED)
