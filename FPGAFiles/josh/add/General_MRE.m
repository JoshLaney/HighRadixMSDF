...
%fig_num = make_plots(Adders_128, '64-Bit Equivalent', fig_num, {'R-4','R-8','Control'});
fig_num = make_plots(Adders_256, '128-Bit Equivalent Adder', fig_num, {'R-2', 'R-4','R-8','Control'});
