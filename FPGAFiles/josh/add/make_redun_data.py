...
a_p = 'r%d_w%d/a_p_data.txt' % (RADIX,WIDTH)
b_p = 'r%d_w%d/b_p_data.txt' % (RADIX,WIDTH)
gold_p = 'r%d_w%d/c_p_data_GOLD.txt' % (RADIX,WIDTH)
a_p_file = open(a_p, 'w')
b_p_file = open(b_p, 'w')
...
a_n = 'r%d_w%d/a_n_data.txt' % (RADIX,WIDTH)
b_n = 'r%d_w%d/b_n_data.txt' % (RADIX,WIDTH)
gold_n = 'r%d_w%d/c_n_data_GOLD.txt' % (RADIX,WIDTH)
a_n_file = open(a_n, 'w')
b_n_file = open(b_n, 'w')
