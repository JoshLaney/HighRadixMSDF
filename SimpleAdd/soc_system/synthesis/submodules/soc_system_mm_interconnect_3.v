...
module soc_system_mm_interconnect_3 (
		...
		input  wire        dma_f2h_reset_reset_bridge_in_reset_reset, // dma_f2h_reset_reset_bridge_in_reset.reset
		input  wire [15:0] dma_f2h_read_master_address,               //                 dma_f2h_read_master.address
		output wire        dma_f2h_read_master_waitrequest,           //                                    .waitrequest
		input  wire        dma_f2h_read_master_chipselect,            //                                    .chipselect
		input  wire        dma_f2h_read_master_read,                  //                                    .read
		output wire [63:0] dma_f2h_read_master_readdata,              //                                    .readdata
		output wire        dma_f2h_read_master_readdatavalid,         //                                    .readdatavalid
		input  wire [15:0] dma_h2f_write_master_address,              //                dma_h2f_write_master.address
		output wire        dma_h2f_write_master_waitrequest,          //                                    .waitrequest
		input  wire [7:0]  dma_h2f_write_master_byteenable,           //                                    .byteenable
		input  wire        dma_h2f_write_master_chipselect,           //                                    .chipselect
		input  wire        dma_h2f_write_master_write,                //                                    .write
		input  wire [63:0] dma_h2f_write_master_writedata,            //                                    .writedata
	...
	wire          dma_f2h_read_master_translator_avalon_universal_master_0_waitrequest;    // dma_f2h_read_master_agent:av_waitrequest -> dma_f2h_read_master_translator:uav_waitrequest
	wire   [63:0] dma_f2h_read_master_translator_avalon_universal_master_0_readdata;       // dma_f2h_read_master_agent:av_readdata -> dma_f2h_read_master_translator:uav_readdata
	wire          dma_f2h_read_master_translator_avalon_universal_master_0_debugaccess;    // dma_f2h_read_master_translator:uav_debugaccess -> dma_f2h_read_master_agent:av_debugaccess
	wire   [15:0] dma_f2h_read_master_translator_avalon_universal_master_0_address;        // dma_f2h_read_master_translator:uav_address -> dma_f2h_read_master_agent:av_address
	wire          dma_f2h_read_master_translator_avalon_universal_master_0_read;           // dma_f2h_read_master_translator:uav_read -> dma_f2h_read_master_agent:av_read
	wire    [7:0] dma_f2h_read_master_translator_avalon_universal_master_0_byteenable;     // dma_f2h_read_master_translator:uav_byteenable -> dma_f2h_read_master_agent:av_byteenable
	wire          dma_f2h_read_master_translator_avalon_universal_master_0_readdatavalid;  // dma_f2h_read_master_agent:av_readdatavalid -> dma_f2h_read_master_translator:uav_readdatavalid
	wire          dma_f2h_read_master_translator_avalon_universal_master_0_lock;           // dma_f2h_read_master_translator:uav_lock -> dma_f2h_read_master_agent:av_lock
	wire          dma_f2h_read_master_translator_avalon_universal_master_0_write;          // dma_f2h_read_master_translator:uav_write -> dma_f2h_read_master_agent:av_write
	wire   [63:0] dma_f2h_read_master_translator_avalon_universal_master_0_writedata;      // dma_f2h_read_master_translator:uav_writedata -> dma_f2h_read_master_agent:av_writedata
	wire    [3:0] dma_f2h_read_master_translator_avalon_universal_master_0_burstcount;     // dma_f2h_read_master_translator:uav_burstcount -> dma_f2h_read_master_agent:av_burstcount
	wire          rsp_mux_src_valid;                                                       // rsp_mux:src_valid -> dma_f2h_read_master_agent:rp_valid
	wire  [122:0] rsp_mux_src_data;                                                        // rsp_mux:src_data -> dma_f2h_read_master_agent:rp_data
	wire          rsp_mux_src_ready;                                                       // dma_f2h_read_master_agent:rp_ready -> rsp_mux:src_ready
	wire    [1:0] rsp_mux_src_channel;                                                     // rsp_mux:src_channel -> dma_f2h_read_master_agent:rp_channel
	wire          rsp_mux_src_startofpacket;                                               // rsp_mux:src_startofpacket -> dma_f2h_read_master_agent:rp_startofpacket
	wire          rsp_mux_src_endofpacket;                                                 // rsp_mux:src_endofpacket -> dma_f2h_read_master_agent:rp_endofpacket
	wire          dma_h2f_write_master_translator_avalon_universal_master_0_waitrequest;   // dma_h2f_write_master_agent:av_waitrequest -> dma_h2f_write_master_translator:uav_waitrequest
	wire   [63:0] dma_h2f_write_master_translator_avalon_universal_master_0_readdata;      // dma_h2f_write_master_agent:av_readdata -> dma_h2f_write_master_translator:uav_readdata
	wire          dma_h2f_write_master_translator_avalon_universal_master_0_debugaccess;   // dma_h2f_write_master_translator:uav_debugaccess -> dma_h2f_write_master_agent:av_debugaccess
	wire   [15:0] dma_h2f_write_master_translator_avalon_universal_master_0_address;       // dma_h2f_write_master_translator:uav_address -> dma_h2f_write_master_agent:av_address
	wire          dma_h2f_write_master_translator_avalon_universal_master_0_read;          // dma_h2f_write_master_translator:uav_read -> dma_h2f_write_master_agent:av_read
	wire    [7:0] dma_h2f_write_master_translator_avalon_universal_master_0_byteenable;    // dma_h2f_write_master_translator:uav_byteenable -> dma_h2f_write_master_agent:av_byteenable
	wire          dma_h2f_write_master_translator_avalon_universal_master_0_readdatavalid; // dma_h2f_write_master_agent:av_readdatavalid -> dma_h2f_write_master_translator:uav_readdatavalid
	wire          dma_h2f_write_master_translator_avalon_universal_master_0_lock;          // dma_h2f_write_master_translator:uav_lock -> dma_h2f_write_master_agent:av_lock
	wire          dma_h2f_write_master_translator_avalon_universal_master_0_write;         // dma_h2f_write_master_translator:uav_write -> dma_h2f_write_master_agent:av_write
	wire   [63:0] dma_h2f_write_master_translator_avalon_universal_master_0_writedata;     // dma_h2f_write_master_translator:uav_writedata -> dma_h2f_write_master_agent:av_writedata
	wire    [3:0] dma_h2f_write_master_translator_avalon_universal_master_0_burstcount;    // dma_h2f_write_master_translator:uav_burstcount -> dma_h2f_write_master_agent:av_burstcount
	wire          rsp_mux_001_src_valid;                                                   // rsp_mux_001:src_valid -> dma_h2f_write_master_agent:rp_valid
	wire  [122:0] rsp_mux_001_src_data;                                                    // rsp_mux_001:src_data -> dma_h2f_write_master_agent:rp_data
	wire          rsp_mux_001_src_ready;                                                   // dma_h2f_write_master_agent:rp_ready -> rsp_mux_001:src_ready
	wire    [1:0] rsp_mux_001_src_channel;                                                 // rsp_mux_001:src_channel -> dma_h2f_write_master_agent:rp_channel
	wire          rsp_mux_001_src_startofpacket;                                           // rsp_mux_001:src_startofpacket -> dma_h2f_write_master_agent:rp_startofpacket
	wire          rsp_mux_001_src_endofpacket;                                             // rsp_mux_001:src_endofpacket -> dma_h2f_write_master_agent:rp_endofpacket
	...
	wire          dma_f2h_read_master_agent_cp_valid;                                      // dma_f2h_read_master_agent:cp_valid -> router:sink_valid
	wire  [122:0] dma_f2h_read_master_agent_cp_data;                                       // dma_f2h_read_master_agent:cp_data -> router:sink_data
	wire          dma_f2h_read_master_agent_cp_ready;                                      // router:sink_ready -> dma_f2h_read_master_agent:cp_ready
	wire          dma_f2h_read_master_agent_cp_startofpacket;                              // dma_f2h_read_master_agent:cp_startofpacket -> router:sink_startofpacket
	wire          dma_f2h_read_master_agent_cp_endofpacket;                                // dma_f2h_read_master_agent:cp_endofpacket -> router:sink_endofpacket
	...
	wire          dma_h2f_write_master_agent_cp_valid;                                     // dma_h2f_write_master_agent:cp_valid -> router_001:sink_valid
	wire  [122:0] dma_h2f_write_master_agent_cp_data;                                      // dma_h2f_write_master_agent:cp_data -> router_001:sink_data
	wire          dma_h2f_write_master_agent_cp_ready;                                     // router_001:sink_ready -> dma_h2f_write_master_agent:cp_ready
	wire          dma_h2f_write_master_agent_cp_startofpacket;                             // dma_h2f_write_master_agent:cp_startofpacket -> router_001:sink_startofpacket
	wire          dma_h2f_write_master_agent_cp_endofpacket;                               // dma_h2f_write_master_agent:cp_endofpacket -> router_001:sink_endofpacket
	...
	wire   [86:0] onchip_memory2_0_s1_agent_rp_data;                                       // onchip_memory2_0_s1_agent:rp_data -> router_002:sink_data
	...
	wire   [86:0] onchip_memory2_0_s1_burst_adapter_source0_data;                          // onchip_memory2_0_s1_burst_adapter:source0_data -> onchip_memory2_0_s1_agent:cp_data
	...
	wire   [86:0] router_002_src_data;                                                     // router_002:src_data -> onchip_memory2_0_s1_rsp_width_adapter:in_data
	...
	wire  [122:0] onchip_memory2_0_s1_rsp_width_adapter_src_data;                          // onchip_memory2_0_s1_rsp_width_adapter:out_data -> rsp_demux:sink_data
	...
	wire  [122:0] cmd_mux_src_data;                                                        // cmd_mux:src_data -> onchip_memory2_0_s1_cmd_width_adapter:in_data
	...
	wire   [86:0] onchip_memory2_0_s1_cmd_width_adapter_src_data;                          // onchip_memory2_0_s1_cmd_width_adapter:out_data -> onchip_memory2_0_s1_burst_adapter:sink0_data
	...
	) dma_f2h_read_master_translator (
		.clk                    (clk_0_clk_clk),                                                          //                       clk.clk
		.reset                  (dma_f2h_reset_reset_bridge_in_reset_reset),                              //                     reset.reset
		.uav_address            (dma_f2h_read_master_translator_avalon_universal_master_0_address),       // avalon_universal_master_0.address
		.uav_burstcount         (dma_f2h_read_master_translator_avalon_universal_master_0_burstcount),    //                          .burstcount
		.uav_read               (dma_f2h_read_master_translator_avalon_universal_master_0_read),          //                          .read
		.uav_write              (dma_f2h_read_master_translator_avalon_universal_master_0_write),         //                          .write
		.uav_waitrequest        (dma_f2h_read_master_translator_avalon_universal_master_0_waitrequest),   //                          .waitrequest
		.uav_readdatavalid      (dma_f2h_read_master_translator_avalon_universal_master_0_readdatavalid), //                          .readdatavalid
		.uav_byteenable         (dma_f2h_read_master_translator_avalon_universal_master_0_byteenable),    //                          .byteenable
		.uav_readdata           (dma_f2h_read_master_translator_avalon_universal_master_0_readdata),      //                          .readdata
		.uav_writedata          (dma_f2h_read_master_translator_avalon_universal_master_0_writedata),     //                          .writedata
		.uav_lock               (dma_f2h_read_master_translator_avalon_universal_master_0_lock),          //                          .lock
		.uav_debugaccess        (dma_f2h_read_master_translator_avalon_universal_master_0_debugaccess),   //                          .debugaccess
		.av_address             (dma_f2h_read_master_address),                                            //      avalon_anti_master_0.address
		.av_waitrequest         (dma_f2h_read_master_waitrequest),                                        //                          .waitrequest
		.av_chipselect          (dma_f2h_read_master_chipselect),                                         //                          .chipselect
		.av_read                (dma_f2h_read_master_read),                                               //                          .read
		.av_readdata            (dma_f2h_read_master_readdata),                                           //                          .readdata
		.av_readdatavalid       (dma_f2h_read_master_readdatavalid),                                      //                          .readdatavalid
	...
	altera_merlin_master_translator #(
		...
		.AV_LINEWRAPBURSTS           (0),
		.AV_REGISTERINCOMINGSIGNALS  (0)
	) dma_h2f_write_master_translator (
		.clk                    (clk_0_clk_clk),                                                           //                       clk.clk
		.reset                  (dma_f2h_reset_reset_bridge_in_reset_reset),                               //                     reset.reset
		.uav_address            (dma_h2f_write_master_translator_avalon_universal_master_0_address),       // avalon_universal_master_0.address
		.uav_burstcount         (dma_h2f_write_master_translator_avalon_universal_master_0_burstcount),    //                          .burstcount
		.uav_read               (dma_h2f_write_master_translator_avalon_universal_master_0_read),          //                          .read
		.uav_write              (dma_h2f_write_master_translator_avalon_universal_master_0_write),         //                          .write
		.uav_waitrequest        (dma_h2f_write_master_translator_avalon_universal_master_0_waitrequest),   //                          .waitrequest
		.uav_readdatavalid      (dma_h2f_write_master_translator_avalon_universal_master_0_readdatavalid), //                          .readdatavalid
		.uav_byteenable         (dma_h2f_write_master_translator_avalon_universal_master_0_byteenable),    //                          .byteenable
		.uav_readdata           (dma_h2f_write_master_translator_avalon_universal_master_0_readdata),      //                          .readdata
		.uav_writedata          (dma_h2f_write_master_translator_avalon_universal_master_0_writedata),     //                          .writedata
		.uav_lock               (dma_h2f_write_master_translator_avalon_universal_master_0_lock),          //                          .lock
		.uav_debugaccess        (dma_h2f_write_master_translator_avalon_universal_master_0_debugaccess),   //                          .debugaccess
		.av_address             (dma_h2f_write_master_address),                                            //      avalon_anti_master_0.address
		.av_waitrequest         (dma_h2f_write_master_waitrequest),                                        //                          .waitrequest
		.av_byteenable          (dma_h2f_write_master_byteenable),                                         //                          .byteenable
		.av_chipselect          (dma_h2f_write_master_chipselect),                                         //                          .chipselect
		.av_write               (dma_h2f_write_master_write),                                              //                          .write
		.av_writedata           (dma_h2f_write_master_writedata),                                          //                          .writedata
		.av_burstcount          (1'b1),                                                                    //               (terminated)
		.av_beginbursttransfer  (1'b0),                                                                    //               (terminated)
		.av_begintransfer       (1'b0),                                                                    //               (terminated)
	...
	altera_merlin_master_agent #(
		...
		.USE_READRESPONSE          (0),
		.USE_WRITERESPONSE         (0)
	) dma_f2h_read_master_agent (
		.clk                   (clk_0_clk_clk),                                                          //       clk.clk
		.reset                 (dma_f2h_reset_reset_bridge_in_reset_reset),                              // clk_reset.reset
		.av_address            (dma_f2h_read_master_translator_avalon_universal_master_0_address),       //        av.address
		.av_write              (dma_f2h_read_master_translator_avalon_universal_master_0_write),         //          .write
		.av_read               (dma_f2h_read_master_translator_avalon_universal_master_0_read),          //          .read
		.av_writedata          (dma_f2h_read_master_translator_avalon_universal_master_0_writedata),     //          .writedata
		.av_readdata           (dma_f2h_read_master_translator_avalon_universal_master_0_readdata),      //          .readdata
		.av_waitrequest        (dma_f2h_read_master_translator_avalon_universal_master_0_waitrequest),   //          .waitrequest
		.av_readdatavalid      (dma_f2h_read_master_translator_avalon_universal_master_0_readdatavalid), //          .readdatavalid
		.av_byteenable         (dma_f2h_read_master_translator_avalon_universal_master_0_byteenable),    //          .byteenable
		.av_burstcount         (dma_f2h_read_master_translator_avalon_universal_master_0_burstcount),    //          .burstcount
		.av_debugaccess        (dma_f2h_read_master_translator_avalon_universal_master_0_debugaccess),   //          .debugaccess
		.av_lock               (dma_f2h_read_master_translator_avalon_universal_master_0_lock),          //          .lock
		.cp_valid              (dma_f2h_read_master_agent_cp_valid),                                     //        cp.valid
		.cp_data               (dma_f2h_read_master_agent_cp_data),                                      //          .data
		.cp_startofpacket      (dma_f2h_read_master_agent_cp_startofpacket),                             //          .startofpacket
		.cp_endofpacket        (dma_f2h_read_master_agent_cp_endofpacket),                               //          .endofpacket
		.cp_ready              (dma_f2h_read_master_agent_cp_ready),                                     //          .ready
	...
	altera_merlin_master_agent #(
		...
		.USE_READRESPONSE          (0),
		.USE_WRITERESPONSE         (0)
	) dma_h2f_write_master_agent (
		.clk                   (clk_0_clk_clk),                                                           //       clk.clk
		.reset                 (dma_f2h_reset_reset_bridge_in_reset_reset),                               // clk_reset.reset
		.av_address            (dma_h2f_write_master_translator_avalon_universal_master_0_address),       //        av.address
		.av_write              (dma_h2f_write_master_translator_avalon_universal_master_0_write),         //          .write
		.av_read               (dma_h2f_write_master_translator_avalon_universal_master_0_read),          //          .read
		.av_writedata          (dma_h2f_write_master_translator_avalon_universal_master_0_writedata),     //          .writedata
		.av_readdata           (dma_h2f_write_master_translator_avalon_universal_master_0_readdata),      //          .readdata
		.av_waitrequest        (dma_h2f_write_master_translator_avalon_universal_master_0_waitrequest),   //          .waitrequest
		.av_readdatavalid      (dma_h2f_write_master_translator_avalon_universal_master_0_readdatavalid), //          .readdatavalid
		.av_byteenable         (dma_h2f_write_master_translator_avalon_universal_master_0_byteenable),    //          .byteenable
		.av_burstcount         (dma_h2f_write_master_translator_avalon_universal_master_0_burstcount),    //          .burstcount
		.av_debugaccess        (dma_h2f_write_master_translator_avalon_universal_master_0_debugaccess),   //          .debugaccess
		.av_lock               (dma_h2f_write_master_translator_avalon_universal_master_0_lock),          //          .lock
		.cp_valid              (dma_h2f_write_master_agent_cp_valid),                                     //        cp.valid
		.cp_data               (dma_h2f_write_master_agent_cp_data),                                      //          .data
		.cp_startofpacket      (dma_h2f_write_master_agent_cp_startofpacket),                             //          .startofpacket
		.cp_endofpacket        (dma_h2f_write_master_agent_cp_endofpacket),                               //          .endofpacket
		.cp_ready              (dma_h2f_write_master_agent_cp_ready),                                     //          .ready
	...
	soc_system_mm_interconnect_3_router router (
		.sink_ready         (dma_f2h_read_master_agent_cp_ready),         //      sink.ready
		.sink_valid         (dma_f2h_read_master_agent_cp_valid),         //          .valid
		.sink_data          (dma_f2h_read_master_agent_cp_data),          //          .data
		.sink_startofpacket (dma_f2h_read_master_agent_cp_startofpacket), //          .startofpacket
		.sink_endofpacket   (dma_f2h_read_master_agent_cp_endofpacket),   //          .endofpacket
		.clk                (clk_0_clk_clk),                              //       clk.clk
		.reset              (dma_f2h_reset_reset_bridge_in_reset_reset),  // clk_reset.reset
	...
	soc_system_mm_interconnect_3_router router_001 (
		.sink_ready         (dma_h2f_write_master_agent_cp_ready),         //      sink.ready
		.sink_valid         (dma_h2f_write_master_agent_cp_valid),         //          .valid
		.sink_data          (dma_h2f_write_master_agent_cp_data),          //          .data
		.sink_startofpacket (dma_h2f_write_master_agent_cp_startofpacket), //          .startofpacket
		.sink_endofpacket   (dma_h2f_write_master_agent_cp_endofpacket),   //          .endofpacket
		.clk                (clk_0_clk_clk),                               //       clk.clk
		.reset              (dma_f2h_reset_reset_bridge_in_reset_reset),   // clk_reset.reset
	...
	altera_merlin_burst_adapter #(
		...
		.reset                 (dma_f2h_reset_reset_bridge_in_reset_reset),               // cr0_reset.reset
	...
	soc_system_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_rst_0_reset (dma_f2h_reset_reset_bridge_in_reset_reset),      // in_rst_0.reset
